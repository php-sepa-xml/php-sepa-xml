...
## [Unreleased](https://github.com/php-sepa-xml/php-sepa-xml/compare/3.2.0...HEAD)

## [3.2.0](https://github.com/php-sepa-xml/php-sepa-xml/compare/3.1.0...3.2.0)
### What's Changed
...
## [3.1.0](https://github.com/php-sepa-xml/php-sepa-xml/compare/2.3.2...3.1.0) - 2026-05-04

### What's Changed

* Fix spelling of Raiffeisenbank and Volksbank by @markusramsak in https://github.com/php-sepa-xml/php-sepa-xml/pull/221
* Update SECURITY.md by @BorislavSabev in https://github.com/php-sepa-xml/php-sepa-xml/pull/224
* Add the "Ultimate Debitor Name" field by @MarkusBauer in https://github.com/php-sepa-xml/php-sepa-xml/pull/228
* Expand unit-test coverage to 568 tests by @BorislavSabev in https://github.com/php-sepa-xml/php-sepa-xml/pull/235
* #229: In the SEPA credit PAIN file there should be customer information on the transfer by @MTijn in https://github.com/php-sepa-xml/php-sepa-xml/pull/230
* Feature/as xml idempotency by @BorislavSabev in https://github.com/php-sepa-xml/php-sepa-xml/pull/236
* Feature/issue 233 dk compliance by @BorislavSabev in https://github.com/php-sepa-xml/php-sepa-xml/pull/237
* Update DEV tooling by @BorislavSabev in https://github.com/php-sepa-xml/php-sepa-xml/pull/238
* GHAs: (deps): Bump dependabot/fetch-metadata from 2.4.0 to 3.1.0 by @dependabot[bot] in https://github.com/php-sepa-xml/php-sepa-xml/pull/242
* GHAs: (deps): Bump actions/cache from 3 to 5 by @dependabot[bot] in https://github.com/php-sepa-xml/php-sepa-xml/pull/240

### New Contributors

* @MarkusBauer made their first contribution in https://github.com/php-sepa-xml/php-sepa-xml/pull/228
* @dependabot[bot] made their first contribution in https://github.com/php-sepa-xml/php-sepa-xml/pull/242

**Full Changelog**: https://github.com/php-sepa-xml/php-sepa-xml/compare/3.0.0...3.1.0
...
- Remove PHP7 from allow_failures [#17](https://github.com/php-sepa-xml/php-sepa-xml/pull/17) ([soullivaneuh](https://github.com/soullivaneuh))
